...
import oni.gouv.ht.Response.ApiResponse;
...
public class UserController {
    ...
    public ResponseEntity<?> createUser(@Valid @RequestPart("userBean") UserBean userBean, @RequestPart("file") MultipartFile file) throws AlreadyExistdException, IOException {
        return ResponseEntity.ok(new ApiResponse<UserBean>(userService.SaveUser(userBean, file), Constant.USER_CREATE));
    }
